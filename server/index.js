...
server.get("/home/bookshelf",(req,res)=>{
  ...
  if(uid){
    let sql="select author,bname,pic from bookdetails where bid in(select bid from shujia where uid= ? )"
...
server.post('/shujiaadd',(req,res)=>{
  ...
  pool.query(sql,[data],(err,result)=>{
    if(err) throw err;
    result.affectedRows ? res.send({code:200,msg:'请求成功'}) : res.send({code:201,msg:'请求失败'})
  })
})
...
server.get("/home/topfast",(req,res)=>{
  var sql="select author,bname,pic from bookdetails where fid=1 or fid=2 or fid=3 order by recommended desc"
  pool.query(sql,(err,result)=>{
    if(err) throw err;
    result.length ? res.send(result) : res.send({msg:'请求错误'})
  })
...
server.get("/home/topnew",(req,res)=>{
  var sql="select author,bname,pic from bookdetails where fid=12 or fid=13 or fid=14 order by recommended desc"
  pool.query(sql,(err,result)=>{
    if(err) throw err;
    result.length ? res.send(result) : res.send({msg:'请求错误'})
  })
...
server.get("/home/topall",(req,res)=>{
  var sql="select author,bname,pic from bookdetails order by recommended desc"
  pool.query(sql,(err,result)=>{
    if(err) throw err;
    result.length ? res.send(result) : res.send({msg:'请求错误'})
  })
...
server.get("/home/topman",(req,res)=>{
  var sql="select author,bname,pic from bookdetails where fid=2 or fid=13 or fid=4 order by recommended desc"
  pool.query(sql,(err,result)=>{
    if(err) throw err;
    result.length ? res.send(result) : res.send({msg:'请求错误'})
  })
...
server.get('/regist/checkuname',(req,res)=>{
  ...
  pool.query(sql,[uname],(err,result)=>{
    if(err) throw err;
    result.length ? res.send({code:201,msg:'查询失败'}) : res.send({code:200,msg:'查询成功'})
  })
})
          ...
          pool.query(sql,[uid,uid],(err,result)=>{
            ...
            if(result.affectedRows){
              ...
              pool.query(sql,[bsid,uid],(err,result)=>{
                if(err) throw err;
                result.affectedRows ? res.send({code:200,msg:'注册成功'}) : res.send({code:201,msg:'注册失败'})
              });
            }
          })
        })
...
server.get('/login',(req,res)=>{
  ...
  pool.query(sql,[uname,upwd],(err,result)=>{
    if(err) throw err 
    result.length ? res.send({code:200,result,msg:"查询成功"}) : res.send({code:201,msg:'查无此人'})
  })
})
...
server.get('/bookdetails/details',(req,res)=>{
  ...
  pool.query(sql,[bname],(err,result)=>{
    if (err) throw err;
    result.length ? res.send({code:200,result:result,msg:"请求成功"}) : res.send({code:201,result:result,msg:"请求失败"})
  })
})
...
server.put('/bookdetails/recommended',(req,res)=>{
  ...
  pool.query(sql,[recommended,bid],(err,result)=>{
    if(err) throw err; 
    result.affectedRows ? res.send({code:200,msg:'更新成功'}) : res.send({code:201,msg:'更新失败'})
  })
})
...
server.get('/bookdetails',(req,res)=>{
  ...
  pool.query(sql,[input,input],(err,result)=>{
    if(err) throw err;
    result.length ? res.send({code:200,result,msg:'查询成功'}) : res.send({code:201,msg:'查询失败'})
  })
})
...
server.post('/comment/send',(req,res)=>{
  ...
  pool.query(sql,[comment],(err,result)=>{
    if(err) throw err;
    result.affectedRows ? res.send({code:200,msg:'添加成功'}) : res.send({code:201,msg:'添加失败'})
  })
})
